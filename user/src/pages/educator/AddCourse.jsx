...
const AddCourse = () => {
  ...
  return (
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 pt-8 pb-0 '>
      <form onSubmit={handleSubmit} className='flex flex-col gap-3 max-w md w-full text-gray-500'>
        ...
        <div>
            ...
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
              <div className='flex justify-between items-center p-4 border-b'>
                <div className='flex items-center'>
                  ...
                  src={assets.dropdown_icon} width={15} alt="" className={`mr-2 cursor-pointer transition-all ${chapter.collapsed && '-rotate-90'}`} />
          ...
          <div className='flex justify-center items-center bg-blue-100 p-2 my-4 rounded-lg cursor-pointer' onClick={() => handleChapter('add')}>+ Add Chapter</div>
